...
from deeplab import feature_preprocess
...
def _get_data(data_provider, dataset_split):
  ...
  feature = data_provider.get(
      [common.FEATURE])[0]
  print(feature)
  feature.set_shape([1, 129, 129, 12])
  ...
  if dataset_split != common.TEST_SET:
    ...
    #segs = None
    class_label = None
  print(class_label, 'class label')
  return feature,  image_name, height, width, class_label
...
def get(dataset,
  ...
  feature,  image_name, height, width, class_label = _get_data(data_provider, dataset_split)
  print(feature, 'feature')
  if class_label is not None:
    #class_label = tf.squeeze(class_label)
    class_label.set_shape([None, None, 1]) #, None, 1])
  original_feature, feature,  class_label = feature_preprocess.preprocess_image_and_label(
      feature,
      class_label,
